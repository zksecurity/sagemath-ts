...
# This file was *autogenerated* from the file tests/property/sage/finite_fields.sage
from sage.all_cmdline import *   # import sage library

_sage_const_7 = Integer(7); _sage_const_13 = Integer(13); _sage_const_101 = Integer(101); _sage_const_1009 = Integer(1009); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_1 = Integer(1); _sage_const_10 = Integer(10); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_6 = Integer(6); _sage_const_11 = Integer(11); _sage_const_0 = Integer(0); _sage_const_16 = Integer(16); _sage_const_17 = Integer(17); _sage_const_23 = Integer(23)
...
for p in [_sage_const_7 , _sage_const_13 , _sage_const_101 , _sage_const_1009 ]:
    F = GF(p)
    print(f"# GF({p})")
    print(f"RESULT: order={F.order()}, char={F.characteristic()}")

    # Element operations with fixed elements
    a, b = F(_sage_const_3 ), F(_sage_const_5 )
    print(f"# {a} + {b} in GF({p})")
    print(f"RESULT: {a + b}")
    print(f"# {a} * {b} in GF({p})")
    print(f"RESULT: {a * b}")
    print(f"# {a}^(-1) in GF({p})")
    print(f"RESULT: {a**(-_sage_const_1 )}")
    print(f"# {a} - {b} in GF({p})")
    print(f"RESULT: {a - b}")
    print(f"# {a} / {b} in GF({p})")
    print(f"RESULT: {a / b}")
    print(f"# {a}^10 in GF({p})")
    print(f"RESULT: {a**_sage_const_10 }")
    print(f"# -{a} in GF({p})")
    print(f"RESULT: {-a}")
...
extension_fields = [
    (_sage_const_2 , _sage_const_4 ),   # GF(16)
    (_sage_const_2 , _sage_const_8 ),   # GF(256)
    (_sage_const_3 , _sage_const_3 ),   # GF(27)
    (_sage_const_5 , _sage_const_2 ),   # GF(25)
    (_sage_const_7 , _sage_const_2 ),   # GF(49)
    (_sage_const_2 , _sage_const_3 ),   # GF(8)
    (_sage_const_3 , _sage_const_2 ),   # GF(9)
]
...
for p, n in extension_fields:
    ...
    print(f"# gen()^{p**n - _sage_const_1 } in GF({p}^{n})")
    print(f"RESULT: {a**(p**n - _sage_const_1 )}")
    ...
    if not a.is_zero():
        ...
        print(f"RESULT: {a * a**(-_sage_const_1 )}")
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 ), (_sage_const_2 , _sage_const_8 ), (_sage_const_5 , _sage_const_2 )]:
    F = GF(p**n, 'a')
    a = F.gen()
    ...
    homomorphism_check = (a + F(_sage_const_1 ))**p == a**p + F(_sage_const_1 )**p
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 ), (_sage_const_2 , _sage_const_8 ), (_sage_const_5 , _sage_const_2 ), (_sage_const_7 , _sage_const_2 )]:
    F = GF(p**n, 'a')
    a = F.gen()
...
conway_cases = [
    (_sage_const_2 , _sage_const_2 ), (_sage_const_2 , _sage_const_3 ), (_sage_const_2 , _sage_const_4 ), (_sage_const_2 , _sage_const_5 ), (_sage_const_2 , _sage_const_6 ), (_sage_const_2 , _sage_const_7 ), (_sage_const_2 , _sage_const_8 ),
    (_sage_const_3 , _sage_const_2 ), (_sage_const_3 , _sage_const_3 ), (_sage_const_3 , _sage_const_4 ),
    (_sage_const_5 , _sage_const_2 ), (_sage_const_5 , _sage_const_3 ),
    (_sage_const_7 , _sage_const_2 ), (_sage_const_7 , _sage_const_3 ),
    (_sage_const_11 , _sage_const_2 ),
...
for p, n in conway_cases:
    try:
        ...
        coeffs = list(cp)[:-_sage_const_1 ]  # All coefficients except leading 1
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 ), (_sage_const_2 , _sage_const_8 )]:
    F = GF(p**n, 'a')

    print(f"# Integer representations in GF({p}^{n})")

    # Test a few elements
    for i in range(min(p**n, _sage_const_10 )):
        elem = F.fetch_int(i)
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 ), (_sage_const_5 , _sage_const_2 )]:
    F = GF(p**n, 'a')
    a = F.gen()
    ...
    divides_check = (p**n - _sage_const_1 ) % order_a == _sage_const_0 
    print(f"# multiplicative_order divides {p}^{n}-1 in GF({p}^{n})")
    print(f"RESULT: {divides_check}")

    # Order of 1 is 1
    order_one = F(_sage_const_1 ).multiplicative_order()
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 ), (_sage_const_2 , _sage_const_8 ), (_sage_const_5 , _sage_const_2 )]:
    ...
    expected_order = p**n - _sage_const_1 
...
F16 = GF(_sage_const_16 , 'a')
F4 = GF(_sage_const_4 , 'b')
...
for p in [_sage_const_7 , _sage_const_13 , _sage_const_17 , _sage_const_23 ]:
    F = GF(p)
...
for p in [_sage_const_7 , _sage_const_13 , _sage_const_101 ]:
    F = GF(p)

    print(f"# Square roots in GF({p})")

    # Test some squares
    for base in [_sage_const_2 , _sage_const_3 , _sage_const_5 ]:
        elem = F(base)
        sq = elem**_sage_const_2 

        if sq.is_square():
            sqrt_val = sq.sqrt()
            # Verify: sqrt^2 == sq
            verify = sqrt_val**_sage_const_2  == sq
...
for p, n in [(_sage_const_2 , _sage_const_4 ), (_sage_const_3 , _sage_const_2 )]:
    F = GF(p**n, 'a')
    a = F.gen()
    b = a + F(_sage_const_1 )
    c = a**_sage_const_2 
    ...
    # Additive identity
    print(f"# a + 0 == a")
    print(f"RESULT: {a + F(_sage_const_0 ) == a}")

    # Multiplicative identity
    print(f"# a * 1 == a")
    print(f"RESULT: {a * F(_sage_const_1 ) == a}")

    # Additive inverse
    print(f"# a + (-a) == 0")
    print(f"RESULT: {a + (-a) == F(_sage_const_0 )}")

    # Multiplicative inverse (for non-zero)
    print(f"# a * a^(-1) == 1")
    print(f"RESULT: {a * a**(-_sage_const_1 ) == F(_sage_const_1 )}")
