...
describe('gen_lattice', () => {
  ...
  test('generates random lattice with n=1', () => {
    const B = gen_lattice({ type: 'random', n: 1, m: 10, q: 14641n, seed: 42 });
  ...
  test('throws for random lattice with n != 1', () => {
    expect(() => gen_lattice({ type: 'random', n: 2 })).toThrow(
      'random bases require n = 1'
    );
  });

  test('generates dual lattice', () => {
    const B = gen_lattice({ m: 10, seed: 42, dual: true });
  ...
  test('reproducible with seed', () => {
    const B1 = gen_lattice({ m: 6, seed: 123 });
    const B2 = gen_lattice({ m: 6, seed: 123 });
  ...
  test('different seeds give different lattices', () => {
    const B1 = gen_lattice({ m: 6, seed: 123 });
    const B2 = gen_lattice({ m: 6, seed: 456 });
  ...
  test('cyclotomic lattice with n=4', () => {
    ...
    const B = gen_lattice({ type: 'cyclotomic', n: 4, m: 8, seed: 42 });
  ...
  test('lattice determinant matches expected value', () => {
    ...
    const n = 4;
    const q = 11n;
    const B = gen_lattice({ n, q, m: 8, seed: 42 });
