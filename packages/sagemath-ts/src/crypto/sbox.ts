...
import { ZZ, Integer } from '../rings/integer_ring.js';
 ...
 */
export const GIFT_SBOX = new SBox([0x1, 0xa, 0x4, 0xc, 0x6, 0xf, 0x3, 0x9, 0x2, 0xd, 0xb, 0x7, 0x5, 0x0, 0x8, 0xe]);
 ...
 */
export const SKINNY_SBOX = new SBox([0xc, 0x6, 0x9, 0x0, 0x1, 0xa, 0x2, 0xb, 0x3, 0x8, 0x5, 0xd, 0x4, 0xe, 0x7, 0xf]);
