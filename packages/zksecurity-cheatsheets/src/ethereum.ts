...
export const precompiles: Record<string, PrecompileInfo> = {
  ...
  pointEvaluation: {
    ...
    gasCost: 50000,
    inputFormat: 'versioned_hash (32) + z (32) + y (32) + commitment (48) + proof (48)',
...
export const bn254Encoding = {
  ...
  // Field modulus
  FIELD_MODULUS: 21888242871839275222246405745257275088696311157297823662689037894645226208583n,
  // Scalar field modulus
  SCALAR_MODULUS: 21888242871839275222246405745257275088548364400416034343698204186575808495617n,
};
